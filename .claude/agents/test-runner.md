---
name: test-runner
description: "Runs pytest tests for py-maidr. Use after writing or modifying code to verify correctness. Handles parametrized tests across matplotlib/seaborn library and plot type combinations."
...
- Always use `uv run pytest` (not bare `pytest`) to ensure correct environment

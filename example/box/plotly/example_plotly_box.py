...
# Create the box plot
fig = go.Figure()
fig.add_trace(go.Box(y=data_group1.tolist(), name="Group 1", marker_color="lightblue"))
fig.add_trace(go.Box(y=data_group2.tolist(), name="Group 2", marker_color="lightgreen"))
fig.add_trace(go.Box(y=data_group3.tolist(), name="Group 3", marker_color="tan"))

...
`PlotType` in `maidr/core/enum/plot_type.py` names **39** plot types. They do
...
added by it, most inside about two weeks, and `ROC` after it. **None of the
twenty-four has been through a user study**.

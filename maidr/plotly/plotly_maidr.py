...
class PlotlyMaidr:
    ...
    def _create_html_tag(
        ...
        # Kept in step with the `use_cdn` branching in `maidr_bundle_children`,
        # where `warn_if_bundle_is_stale` is called: these are two readings of
        # the same decision in two places, and the schema this one needs is not

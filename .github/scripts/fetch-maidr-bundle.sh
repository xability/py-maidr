...
# 15:16:18, when the dispatch that publish sent had already started this
...
# leaving ``main`` on the previous bundle until somebody re-runs it.
# Both overridable so a test can exercise the loop without waiting.

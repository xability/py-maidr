...
* Stacked bar plot — several bar traces under `barmode="stack"`, and the percentage variant under `barmode="relative"` with normalized values.
...
* KDE plot drawn as a density curve over a histogram, with the curve read as its own layer.
...
* Filled area plot and stacked area plot (`fill="tozeroy"` / `"tonexty"`, `px.area`), including the percentage-normalized variant.

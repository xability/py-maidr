...
## Gantt Chart [experimental] {#gantt-chart}
...
The whole chart is one layer, organized into **lanes**. Each `broken_barh()`
...
falls back to the center of the row it was drawn on — the `(10, 6)` above puts

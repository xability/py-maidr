...
## Area Plot [experimental] {#area-plot}
...
## Error Bar Plot [experimental] {#error-bar-plot}
...
## Point Plot [experimental] {#point-plot}

::: {.callout-warning title="Prototype"}
A point plot is read through the error bar layer, which is one of the
experimental plot types. It has not been through a user study, and it may
...
## Lollipop Plot [experimental] {#lollipop-plot}
